...
public class MovementParkour extends Movement {
    ...
    private final XEnumFacing direction;
    private final int dist;
    private final boolean ascend;

    private MovementParkour(IBaritone baritone, BetterBlockPos src, int dist, XEnumFacing dir, boolean ascend) {
    ...
    public static MovementParkour cost(CalculationContext context, BetterBlockPos src, XEnumFacing direction) {
    ...
    public static void cost(CalculationContext context, int x, int y, int z, XEnumFacing dir, MutableMoveResult res) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            int againstY = y - 1 + HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP[i].getFrontOffsetY();
