...
{
    DOWN("DOWN", 0, 0, 1, -1, "down", XEnumFacing.AxisDirection.NEGATIVE, XEnumFacing.Axis.Y, new Vec3i(0, -1, 0), EnumFacing.DOWN),
    UP("UP", 1, 1, 0, -1, "up", XEnumFacing.AxisDirection.POSITIVE, XEnumFacing.Axis.Y, new Vec3i(0, 1, 0), EnumFacing.UP),
    NORTH("NORTH", 2, 2, 3, 2, "north", XEnumFacing.AxisDirection.NEGATIVE, XEnumFacing.Axis.Z, new Vec3i(0, 0, -1), EnumFacing.NORTH),
    SOUTH("SOUTH", 3, 3, 2, 0, "south", XEnumFacing.AxisDirection.POSITIVE, XEnumFacing.Axis.Z, new Vec3i(0, 0, 1), EnumFacing.SOUTH),
    WEST("WEST", 4, 4, 5, 1, "west", XEnumFacing.AxisDirection.NEGATIVE, XEnumFacing.Axis.X, new Vec3i(-1, 0, 0), EnumFacing.WEST),
    EAST("EAST", 5, 5, 4, 3, "east", XEnumFacing.AxisDirection.POSITIVE, XEnumFacing.Axis.X, new Vec3i(1, 0, 0), EnumFacing.EAST);
    ...
    private XEnumFacing(String p_i17_3_, int p_i17_4_, int p_i17_5_, int p_i17_6_, int p_i17_7_, String p_i17_8_, XEnumFacing.AxisDirection p_i17_9_, XEnumFacing.Axis p_i17_10_, Vec3i p_i17_11_, EnumFacing vanillaEquivalent)
    {
        this.index = p_i17_5_;
    ...
    public static XEnumFacing fromVanilla(EnumFacing enumFacing) {
    	return XEnumFacing.byName(enumFacing.name());
    }
	...
	public int toSideHit() {
		return XHelper.facingToInt(this);
	}
	
	public static XEnumFacing getHorizontal(Entity entity) {
		return XEnumFacing.getHorizontal(MathHelper.floor_double(entity.rotationYaw * 4.0f / 360.0f + 0.5) & 0x3);
	}
}
