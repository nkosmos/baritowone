...
public abstract class BlockStateBase implements IBlockState
{
    ...
    public int getBlockStateId()
    {
        ...
        {
            this.blockStateId = getStateId(this);
        }

        return this.blockStateId;
    }
    
    private static int getStateId(IBlockState blockState) {
    	Block block = blockState.getBlock();
        return Block.getIdFromBlock(block) + (XBlockStateSerializer.getMetaFromState(blockState) << 12);
    }
    ...
    public int getMetadata()
    {
        if (this.metadata < 0)
        {
            this.metadata = XBlockStateSerializer.getMetaFromState(this);
        }
    ...
    public ResourceLocation getBlockLocation()
    {
        ...
        {
            this.blockLocation = new ResourceLocation(Block.blockRegistry.getNameForObject(this.getBlock()));
        }
