...
public class XBlockStateSerializer {
	...
	public static IBlockState getStateFromWorld(IBlockAccess access, BlockPos bp) {
		return getStateFromWorld(access, bp.getX(), bp.getY(), bp.getZ());
	}
	...
	public static IBlockState getStateFromChunk(Chunk access, BlockPos bp) {
		return getStateFromChunk(access, bp.getX(), bp.getY(), bp.getZ());
	}
