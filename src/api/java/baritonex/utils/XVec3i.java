...
public class XVec3i implements Comparable<XVec3i>
{
    /** The Null vector constant (0, 0, 0) */
    public static final XVec3i NULL_VECTOR = new XVec3i(0, 0, 0);
    /** X coordinate */
    private final int x;
    /** Y coordinate */
    private final int y;
    ...
    public XVec3i(int xIn, int yIn, int zIn)
    {
        this.x = xIn;
        this.y = yIn;
        this.z = zIn;
    ...
    public XVec3i(double xIn, double yIn, double zIn)
    {
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else if (!(p_equals_1_ instanceof XVec3i))
        {
            return false;
        }
        else
        {
        	XVec3i vec3i = (XVec3i)p_equals_1_;
    ...
    public int compareTo(XVec3i p_compareTo_1_)
    {
     ...
     */
    public XVec3i crossProduct(XVec3i vec)
    {
        return new XVec3i(this.getY() * vec.getZ() - this.getZ() * vec.getY(), this.getZ() * vec.getX() - this.getX() * vec.getZ(), this.getX() * vec.getY() - this.getY() * vec.getX());
    }
     ...
     */
    public double distanceSq(XVec3i to)
    {
