...
public interface ISelectionManager {
     ...
     */
    ISelection expand(ISelection selection, XEnumFacing direction, int blocks);
     ...
     */
    ISelection contract(ISelection selection, XEnumFacing direction, int blocks);
     ...
     */
    ISelection shift(ISelection selection, XEnumFacing direction, int blocks);
}
